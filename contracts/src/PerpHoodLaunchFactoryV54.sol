...
contract PerpHoodSpotMarketV54 {
    ...
    address public immutable factory;
    address public immutable creator;
    PerpHoodTokenV54 public immutable token;
    bytes32 public immutable metadataHash;
...
contract PerpHoodLaunchFactoryV54 {
    ...
    PerpHoodSpotMarketV54[] public markets;
    ...
    function createMarket(
        ...
        bytes32 metadataHash,
        uint256 migrationTargetUsdWad
    ) external payable nonReentrant returns (PerpHoodSpotMarketV54 market, PerpHoodTokenV54 token) {
        ...
        market = new PerpHoodSpotMarketV54{value: msg.value}(
            msg.sender,
            name,
            symbol,
            metadataURI,
    ...
    function setMarketPaused(PerpHoodSpotMarketV54 market, bool paused) external onlyOwner {
