...
/// @title BattleTokenV23
/// @notice Minimal one-billion-supply token used by the V23 local-chain BattlePool.
...
/// @title LocalBattlePoolV23
/// @notice V23 local-chain custody and ordered settlement spine for PERPHOOD.
/// @dev The deterministic TypeScript engine remains the pricing and liquidation oracle in V23.
...
contract LocalBattlePoolV23 {
    ...
    BattleTokenV23 public immutable token;
    ...
    constructor(address owner_, address sequencer_, bytes32 marketId_, string memory tokenName_, string memory tokenSymbol_) {
        ...
        marketId = marketId_;
        token = new BattleTokenV23(tokenName_, tokenSymbol_, TOTAL_TOKEN_SUPPLY, address(this));
    ...
    /// @dev The main wallet calls this once. The V23 sequencer verifies P-256 signatures off-chain,
    ...
    /// @dev Signature verification happens in the V23 relay; this contract constrains what that
