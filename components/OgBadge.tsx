...
export function OgBadge({ token, compact = false }: { token: Token; compact?: boolean }) {
  ...
  const detail = isOg
    ? token.isTickerOrigin
      ? "Original LEVERAGE X listing for this ticker and the first observed use of this ticker + artwork pairing. This is not an endorsement."
      : "First observed use of this artwork with this ticker on LEVERAGE X. This is not an endorsement."
