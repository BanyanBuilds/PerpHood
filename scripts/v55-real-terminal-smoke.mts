...
check(pkg.name.startsWith("leveragex-v"), "package preserves the versioned Leverage X identity");
check(Number(pkg.version.split(".")[0]) >= 55, "package remains V55-compatible or newer");
