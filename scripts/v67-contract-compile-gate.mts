...
writeFileSync(resolve("deployments", "v67-contract-compile-gate.json"), `${JSON.stringify(report, null, 2)}\n`);
...
console.log("No transaction was signed or broadcast. Report: deployments/v67-contract-compile-gate.json");
