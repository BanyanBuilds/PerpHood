...
assert.match(files.package, /perphood-v48-live-data-plane|perphood-v49-settlement-math-verification|perphood-v50-formal-invariants|perphood-v51-compiler-chain-assault|perphood-v52-product-completion|perphood-v53-supabase-user-state|leveragex-v55-real-trading-terminal/);
